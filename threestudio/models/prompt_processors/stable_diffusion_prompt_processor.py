...
class StableDiffusionPromptProcessor(PromptProcessor):
    ...
    def get_text_embeddings(
        self, prompt: Union[str, List[str]], negative_prompt: Union[str, List[str]], prompt_tgt: Union[str, List[str]]
    ...
    @staticmethod
    def spawn_func(pretrained_model_name_or_path, prompts, cache_dir, target_word=None):
        os.environ["TOKENIZERS_PARALLELISM"] = "false"
