...
@threestudio.register("stable-diffusion-test-guidance")
class StableDiffusionTestGuidance(BaseObject):
    @dataclass
    ...
    def compute_grad_sds(
        ...
        if self.cfg.scale == -1.0:
            ...
            # print(t.item(), scale)
            scale = int(1 - t.item() / 1000)
        else:
            scale = self.cfg.scale
        self.adapter.set_scale(scale)
        
        cond_text_embeddings_vd, uncond_text_embeddings_vd = prompt_utils.get_text_embeddings(
