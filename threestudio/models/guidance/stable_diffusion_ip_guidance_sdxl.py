...
from diffusers import DDIMScheduler, AutoencoderKL, DDPMScheduler, StableDiffusionXLPipeline
...
@threestudio.register("stable-diffusion-ip-guidance-sdxl")
class StableDiffusionIPGuidanceXL(BaseObject):
    @dataclass
    ...
    def configure(self) -> None:
        ...
        self.pipe.load_lora_weights("dog-god/texture-synthesis-sdxl-lora",
