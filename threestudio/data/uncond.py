...
class RandomCameraDataModuleConfig:
    ...
    progressive_until: int = 2500  # progressive ranges for elevation, azimuth, r, fovy
...
class RandomCameraIterableDataset(IterableDataset, Updateable):
    ...
    def progressive_view(self, global_step):
        ...
        # ]
        self.camera_distance_range = [
            (1 - r) * self.cfg.camera_distance_range[0] + r * 2.5,
            (1 - r) * self.cfg.camera_distance_range[1] + r * 2.5,
        ]
        # self.fovy_range = [
        ...
        # ]
        threestudio.info(
            f"camera distance range: {self.camera_distance_range}"
        )
